...
| Rank | Author | Params | Accuracy | Architecture | Verification | Method | Time | Failure Reason |
|------|--------|-------:|----------|--------------|:------------:|--------|-----:|----------------|
...
| 7 | jacobli99 | 28 | 100% | 1L decoder, d=2, 5h (MQA), hd=2, ff=4 | VERIFIED | SMT (Z3) | 3.2s | — |
| 8 | Arch222 | 31 | 100% | 1L decoder, d=3, 4h/1kv, hd=2, ff=4 | NOT RUN | — | — | Missing module `tiny_transformer_adder` |
| 9 | fblissjr | 33 | 100% | 1L decoder, d=3, 3h (d_head=1), ff=4 | VERIFIED | SMT (Z3) | 3.3s | — |
| 10 | alexlitz | 36 | 100% | 2L decoder, d=5, 5h+1h | VERIFIED | SMT (Z3) | 3.5s | — |
| 11 | lichengliu03 | 50 | 100% | 1L custom GPT, d=4, 2h, hd=2 | VERIFIED | SMT (Z3) | 4.4s | — |
...
| 16 | nino | 116 | 100% | 1L Qwen3, d=3, 4h/1kv, hd=2 | VERIFIED | SMT (Z3) | 3.6s | — |
...
| 2 | lokimorty | 39 | 99.91% | 1L Qwen3, d=3, 1h/1kv, hd=4, ff=2 | VERIFIED | SMT (Z3) | 3.4s | — |
...
| 18 | dimopep | 140 | 100% | 1L decoder, d=4, 1h/1kv, hd=4, ff=4 | VERIFIED | SMT (Z3) | 3.4s | — |
...
| Falsified (counterexample found) | 0 |
