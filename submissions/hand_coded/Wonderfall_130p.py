...
CARRY_GATE = ALPHA / (1.0 + math.exp(-ALPHA))
...
def hand_set_weights_better(model: Model) -> None:
    ...
    # - single linear carry surrogate c_lin = 0.05 - 0.1*x
    # - z = s + c_lin - 10*w; decode picks nearest digit
